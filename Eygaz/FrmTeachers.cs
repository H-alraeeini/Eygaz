...
namespace Eygaz
{
    public partial class FrmTeachers : MetroFramework.Forms.MetroForm
    {
        Func f = new Func();
        ...
        private void FillGrid()
        {
            ...
            if (GrdDtl.Columns.Count > 0)
            {
                ...
                GrdDtl.Columns[2].Caption = "العنوان";
                GrdDtl.Columns[3].Caption = "التلفون";
                GrdDtl.Columns[4].Caption = "النوع";
                GrdDtl.Columns[5].Caption = "الحاله";
                GrdDtl.Columns[6].Caption = "الملاحظات";
            ...
            try
            {
                ...
                if (GrdDtl.RowCount > 0)
                {
                    ...
                    if (row != null)
                    {
                        ...
                        // 🔹 استخدم StringBuilder لكتابة استعلام جدول Teachers
                        var sb = new System.Text.StringBuilder();
                        sb.AppendLine("SELECT ");
                        sb.AppendLine("Id, FullName,  Address, Phone, Gender, ");
                        sb.AppendLine("IsActive, Notes, CreatedAt ");
                        sb.AppendLine("FROM Teachers WHERE Id = " + id + ";");
